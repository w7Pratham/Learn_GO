...
type IntermediateStackProps struct {
	awscdk.StackProps
}

func NewIntermediateStack(scope constructs.Construct, id string, props *IntermediateStackProps) awscdk.Stack {
...
func main() {
	...
	NewIntermediateStack(app, "IntermediateStack", &IntermediateStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
